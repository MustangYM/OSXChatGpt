...
public struct MarkdownTheme {
    ...
    fileprivate static func load(fromPath path: String, size: CGFloat) -> NSFont? {
        guard
...
extension MarkdownTheme {
    ...
    static func defaultFont(_ size: CGFloat = 14) -> Font {
        ...
        #else
        font = load(fromPath: "/Library/Fonts/Courier New.ttf", size: size)
        #endif

//        return (font ?? .systemFont(ofSize: CGFloat(size))).toFont
        return Font.system(size: 13, weight: .regular, design: .monospaced)
    }
    
    /// Create a theme matching the "Sundell's Colors" Xcode theme
    static func sundellsColors(withFont font: Font = defaultFont()) -> MarkdownTheme {
    ...
    static func midnight(withFont font: Font) -> MarkdownTheme {
        return MarkdownTheme(
            font: font,
            plainTextColor: Color(
                red: 1,
    ...
    static func wwdc17(withFont font: Font = defaultFont()) -> MarkdownTheme {
        return MarkdownTheme(
            font: font,
            plainTextColor: Color(
                red: 0.84,
    ...
    static func wwdc18(withFont font: Font = defaultFont()) -> MarkdownTheme {
        return MarkdownTheme(
            font: font,
            plainTextColor: Color(
                red: 1,
    ...
    static func sunset(withFont font: Font = defaultFont()) -> MarkdownTheme {
        return MarkdownTheme(
            font: font,
            plainTextColor: Color(
                red: 0,
    ...
    static func presentation(withFont font: Font) -> MarkdownTheme {
        return MarkdownTheme(
            font: font,
            plainTextColor: Color(
                red: 0,
